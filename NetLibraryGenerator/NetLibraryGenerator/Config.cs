namespace NetLibraryGenerator
{
    public static class Config
    {
        ...
        public const string EXCEPTIONS_FOLDER_NAME = "Exceptions";
        public const string EVENT_HANDLERS_FOLDER_NAME = "EventHandlers";

        public const string SAFE_MODEL_FOLDER_NAME = "Local";
